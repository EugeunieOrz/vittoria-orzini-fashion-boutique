...
object BasicSettings extends AutoPlugin {
  ...
  override def projectSettings: Seq[Setting[_]] = Seq(
    organization := "vittoria.orzini.fashion.boutique",
    version := "5.0.0",
...
object PackageSettings extends AutoPlugin {
  ...
  override def projectSettings: Seq[Setting[_]] = Seq(
    maintainer := "Ievgeniia Ozirna <eugeunie@gmail.com>",
    packageSummary := "Vittoria Orzini Fashion Boutique and Online Store",
    packageDescription := "Vittoria Orzini Fashion Boutique and Online Store",
