 ...
 */
trait Formats extends utils.core.json.Formats {
 ...
 */
object MongoFormats extends utils.core.json.MongoFormats with Formats {
 ...
 */
object APIFormats extends utils.core.json.APIFormats with Formats
