...
import DressesColorFilter from 'components/ProductsPage/Filters/DressesColorFilter';
...
export default connect(mapStateToProps, mapDispatchToProps)(lifecycle(DressesColorFilter));
