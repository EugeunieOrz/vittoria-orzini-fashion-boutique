...
import { modelPath } from 'bundles/Account/modules/Addresses/EditAddressFormModule';
...
export const EditAddressComponent = ({
  form, isPending, i18n, t, index, onEditAddress, userID, toggleEditAddress,
}: Props) => (
  <Container
    className={
    ...
    <Row className="px-1 px-md-3 px-lg-0">
      ...
      <Col xs={12} sm={8} md={7}>
        ...
        <Form
          ...
          model={modelPath} onSubmit={data => onEditAddress(userID, index, 'N/A', data)}
          ...
          <Row>
            <Col xs={12} lg={6}>
              ...
              <Errors
                ...
                wrapper={(props) => <div className={
                  i18n.translator.language === "ar" ?
                  "text-right address-email-error-ar" :
                  "address-email-error"
                }>
                  {props.children[0]}<br />{props.children[1]}</div>}
                show="focus"
...
export default withTranslation()(EditAddressComponent);
