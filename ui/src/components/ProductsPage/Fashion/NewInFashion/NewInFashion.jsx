...
import NewInFashionFilters from 'components/ProductsPage/Filters/NewInFashionFilters';
...
export const NewInFashionComponent = ({
    ...
    <Row
      ...
      <div className="d-flex flex-row mt-2">
        ...
        <div
          ...
          onClick={() => selectFashionCategory("new-arrivals")}>
          {t('New Arrivals')}
        </div>
      </div>
    </Row>
...
export default withTranslation()(NewInFashionComponent);
