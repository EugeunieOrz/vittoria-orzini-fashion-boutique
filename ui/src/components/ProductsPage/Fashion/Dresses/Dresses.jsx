...
import DressesFilters from 'components/ProductsPage/Filters/DressesFilters';
    ...
    <Row
      ...
      <div className="d-flex flex-row mt-2">
        ...
        <div
          ...
          onClick={() => selectFashionCategory("dresses")}>
          <Trans>Dresses</Trans>
        </div>
      </div>
    </Row>
        ...
        filterBy(
          ...
          <Col xs={6} md={4} lg={3} key={index}>
            <Figure className="img-figure">
              <Figure.Image
                src={require(`../../../../static/fashion/ready-to-wear/dresses/${product.links[0]}`)}
                alt="Fashion"
                width={300}
                height={400}
                ...
                onMouseOver={e => {
                  e.currentTarget.src = require(`../../../../static/fashion/ready-to-wear/dresses/${product.links[1]}`)
                }}
                onMouseLeave={e => {
                  e.currentTarget.src = require(`../../../../static/fashion/ready-to-wear/dresses/${product.links[0]}`)
                }}
              />
            <Figure.Caption>
...
export default withTranslation()(DressesComponent);
