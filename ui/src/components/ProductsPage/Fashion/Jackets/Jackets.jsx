...
import JacketsFilters from 'components/ProductsPage/Filters/JacketsFilters';
...
export const JacketsComponent = ({
  i18n, t, products, selectFashionCategory, switchToProductView, userID,
  sizeCategory, colorCategory, orderCategory,
}: Props) => (
  <CoreContainer>
    <Row
      ...
      <div className="d-flex flex-row mt-2">
        ...
        <div
          ...
          onClick={() => selectFashionCategory("jackets")}>
          {t('Jackets')}
        </div>
      </div>
    </Row>
        ...
        filterJacketsBy(
          ...
          <Col xs={6} md={4} lg={3} key={index}>
            <Figure className="img-figure">
              <Figure.Image
                src={require(`../../../../static/fashion/ready-to-wear/jackets/${product.links[0]}`)}
                alt="Fashion"
                width={300}
                height={400}
                ...
                onMouseOver={e => {
                  e.currentTarget.src = require(`../../../../static/fashion/ready-to-wear/jackets/${product.links[1]}`)
                }}
                onMouseLeave={e => {
                  e.currentTarget.src = require(`../../../../static/fashion/ready-to-wear/jackets/${product.links[0]}`)
                }}
              />
            <Figure.Caption>
...
export default withTranslation()(JacketsComponent);
