...
import categories from '../../../static/json/hccategories.json';
...
export const HomeCollectionMenuComponent = ({
  i18n, t, language, selectFashionCategory, closeHomeCollectionMenu,
  homeCollectionMenuOpened, toggleHomeCollectionMenu,
}: Props) => (
  <Row className={
      homeCollectionMenuOpened ?
      ...
      "mt-5 pb-5 fashion-menu-dropdown"
       ...
       onMouseLeave={() => closeHomeCollectionMenu()}>
       <Col lg={2}></Col>
       {
...
export default withTranslation()(HomeCollectionMenuComponent);
